  ...
  create view "fastdeliver"."main_staging"."stg_pedidos__dbt_tmp" as (
    with source as (
    select * from read_csv_auto('../gen/data/fastdeliver_clean.csv')
),
...
renamed as (
    select
        ...
        cast(courier_assigned_at as timestamp) as courier_assigned_at,
        ...
        cast(stage_3_courier_assigned_at as timestamp) as stage_3_courier_assigned_at,
        cast(stage_4_courier_arrived_restaurant_at as timestamp) as stage_4_courier_arrived_restaurant_at,
        cast(stage_5_order_picked_up_at as timestamp) as stage_5_order_picked_up_at,
        cast(stage_6_courier_near_customer_at as timestamp) as stage_6_courier_near_customer_at,
        ...
        cast(has_missing_courier_flag as boolean) as has_missing_courier_flag,
