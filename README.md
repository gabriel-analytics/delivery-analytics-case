# FastDeliver Delivery Analytics — End-to-End Analytics Engineering Case
...
| Courier não atribuído | 97 pedidos (1%) | `has_missing_courier_flag` | Imputação `"UNASSIGNED"` |
...
```
delivery-analytics-case/
│
├── 📊 gen/data/
│   ├── generate_fastdeliver.py     # Geração sintética reprodutível (seed=42)
...
git clone https://github.com/gabriel-analytics/delivery-analytics-case
cd delivery-analytics-case
